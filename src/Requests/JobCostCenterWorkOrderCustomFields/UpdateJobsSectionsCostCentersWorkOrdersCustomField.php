...
namespace StevenGrant\SimproSdk\Requests\JobCostCenterWorkOrderCustomFields;
...
/**
 * updateJobsSectionsCostCentersWorkOrdersCustomField
 */
class UpdateJobsSectionsCostCentersWorkOrdersCustomField extends Request implements HasBody
{
    use HasJsonBody;

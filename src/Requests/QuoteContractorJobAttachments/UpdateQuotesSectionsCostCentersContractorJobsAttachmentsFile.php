...
/**
 * updateQuotesSectionsCostCentersContractorJobsAttachmentsFile
 */
class UpdateQuotesSectionsCostCentersContractorJobsAttachmentsFile extends Request implements HasBody
{
    use HasJsonBody;

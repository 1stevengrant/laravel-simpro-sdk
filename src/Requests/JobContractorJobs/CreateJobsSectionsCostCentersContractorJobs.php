...
namespace StevenGrant\SimproSdk\Requests\JobContractorJobs;
...
/**
 * createJobsSectionsCostCentersContractorJobs
 */
class CreateJobsSectionsCostCentersContractorJobs extends Request implements HasBody
{
    use HasJsonBody;

...
namespace StevenGrant\SimproSdk\Requests\ContractorTimesheets;

use Saloon\Enums\Method;
use Saloon\Http\Request;

/**
 * listContractorsTimesheets
 */
class ListContractorsTimesheets extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/contractors/{$this->contractorId}/timesheets";
    }

...
namespace StevenGrant\SimproSdk\Requests\JobTimelines;
 ...
 * listJobsTimelines
 */
class ListJobsTimelines extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/jobs/{$this->jobId}/timelines";
    }

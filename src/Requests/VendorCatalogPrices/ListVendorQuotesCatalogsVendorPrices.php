...
/**
 * listVendorQuotesCatalogsVendorPrices
 */
class ListVendorQuotesCatalogsVendorPrices extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/vendorQuotes/{$this->vendorQuoteId}/catalogs/{$this->catalogId}/vendorPrices";
    }

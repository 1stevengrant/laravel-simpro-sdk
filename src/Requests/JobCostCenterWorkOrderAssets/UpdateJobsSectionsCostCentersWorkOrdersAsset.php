...
namespace StevenGrant\SimproSdk\Requests\JobCostCenterWorkOrderAssets;
...
/**
 * updateJobsSectionsCostCentersWorkOrdersAsset
 */
class UpdateJobsSectionsCostCentersWorkOrdersAsset extends Request implements HasBody
{
    use HasJsonBody;

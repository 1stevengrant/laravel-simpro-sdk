...
/**
 * listVendorOrdersReceiptsCreditsCatalogs
 */
class ListVendorOrdersReceiptsCreditsCatalogs extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/vendorOrders/{$this->vendorOrderId}/receipts/{$this->vendorReceiptId}/credits/{$this->vendorCreditId}/catalogs";
    }

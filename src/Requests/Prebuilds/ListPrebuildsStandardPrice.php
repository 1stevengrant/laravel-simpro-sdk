...
/**
 * listPrebuildsStandardPrice
 */
class ListPrebuildsStandardPrice extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/prebuilds/standardPrice";
    }
     ...
     * @param  null|mixed  $searchText  Set a wildcard search text to filter prebuilds by name or part number.
     */
    public function __construct(
        ...
        protected mixed $searchText = null,
    ) {}

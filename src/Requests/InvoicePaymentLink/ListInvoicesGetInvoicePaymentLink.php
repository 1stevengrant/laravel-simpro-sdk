...
namespace StevenGrant\SimproSdk\Requests\InvoicePaymentLink;

use Saloon\Enums\Method;
use Saloon\Http\Request;

/**
 * listInvoicesGetInvoicePaymentLink
 */
class ListInvoicesGetInvoicePaymentLink extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/invoices/{$this->invoiceId}/getInvoicePaymentLink";
    }

...
namespace StevenGrant\SimproSdk\Requests\PayableInvoices;

use Saloon\Enums\Method;
use Saloon\Http\Request;

/**
 * listAccountsPayableInvoices
 */
class ListAccountsPayableInvoices extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/accounts/payable/invoices";
    }

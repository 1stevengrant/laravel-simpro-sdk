...
/**
 * listRecurringInvoicesCustomFields
 */
class ListRecurringInvoicesCustomFields extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/recurringInvoices/{$this->recurringInvoiceId}/customFields";
    }

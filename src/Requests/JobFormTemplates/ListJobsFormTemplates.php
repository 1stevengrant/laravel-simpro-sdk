...
namespace StevenGrant\SimproSdk\Requests\JobFormTemplates;

use Saloon\Enums\Method;
use Saloon\Http\Request;

/**
 * listJobsFormTemplates
 */
class ListJobsFormTemplates extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/jobs/{$this->jobId}/formTemplates";
    }

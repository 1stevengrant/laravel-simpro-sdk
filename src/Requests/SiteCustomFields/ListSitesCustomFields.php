...
namespace StevenGrant\SimproSdk\Requests\SiteCustomFields;

use Saloon\Enums\Method;
use Saloon\Http\Request;

/**
 * listSitesCustomFields
 */
class ListSitesCustomFields extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/sites/{$this->siteId}/customFields";
    }

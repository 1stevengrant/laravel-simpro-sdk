...
namespace StevenGrant\SimproSdk\Requests\CostToCompleteFinancialView;

use Saloon\Enums\Method;
use Saloon\Http\Request;

/**
 * listReportsJobsCostToCompleteFinancial
 */
class ListReportsJobsCostToCompleteFinancial extends Request
{

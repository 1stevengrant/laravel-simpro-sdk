...
/**
 * updateQuotesSectionsCostCentersWorkOrdersAttachmentsFile
 */
class UpdateQuotesSectionsCostCentersWorkOrdersAttachmentsFile extends Request implements HasBody
{
    use HasJsonBody;

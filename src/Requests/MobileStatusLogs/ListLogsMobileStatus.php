...
namespace StevenGrant\SimproSdk\Requests\MobileStatusLogs;

use Saloon\Enums\Method;
use Saloon\Http\Request;

/**
 * listLogsMobileStatus
 */
class ListLogsMobileStatus extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/logs/mobileStatus";
    }

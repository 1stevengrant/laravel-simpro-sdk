...
/**
 * listSitesAssetsCustomFields
 */
class ListSitesAssetsCustomFields extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/sites/{$this->siteId}/assets/{$this->assetId}/customFields";
    }

...
namespace StevenGrant\SimproSdk\Requests\InvoiceForms;
 ...
 * getInvoicesViewForm
 */
class GetInvoicesViewForm extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/invoices/{$this->invoiceId}/viewForm/{$this->formTemplateId09}";
    }
    ...
    public function __construct(
        ...
        protected mixed $formTemplateId,

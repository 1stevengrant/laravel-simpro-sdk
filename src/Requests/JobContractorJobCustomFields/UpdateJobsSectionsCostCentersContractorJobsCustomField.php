...
namespace StevenGrant\SimproSdk\Requests\JobContractorJobCustomFields;
...
/**
 * updateJobsSectionsCostCentersContractorJobsCustomField
 */
class UpdateJobsSectionsCostCentersContractorJobsCustomField extends Request implements HasBody
{
    use HasJsonBody;

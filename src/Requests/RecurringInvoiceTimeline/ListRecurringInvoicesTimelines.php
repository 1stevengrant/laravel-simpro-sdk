...
namespace StevenGrant\SimproSdk\Requests\RecurringInvoiceTimeline;

use Saloon\Enums\Method;
use Saloon\Http\Request;

/**
 * listRecurringInvoicesTimelines
 */
class ListRecurringInvoicesTimelines extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/recurringInvoices/{$this->recurringInvoiceId}/timelines";
    }

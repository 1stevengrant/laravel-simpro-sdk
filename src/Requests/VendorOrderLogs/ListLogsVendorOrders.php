...
namespace StevenGrant\SimproSdk\Requests\VendorOrderLogs;

use Saloon\Enums\Method;
use Saloon\Http\Request;

/**
 * listLogsVendorOrders
 */
class ListLogsVendorOrders extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/logs/vendorOrders";
    }

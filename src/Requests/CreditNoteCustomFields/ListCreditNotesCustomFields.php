...
/**
 * listCreditNotesCustomFields
 */
class ListCreditNotesCustomFields extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/creditNotes/{$this->creditNoteId}/customFields";
    }

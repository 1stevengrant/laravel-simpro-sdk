...
namespace StevenGrant\SimproSdk\Requests\CustomerResponseTimeSearch;

use Saloon\Enums\Method;
use Saloon\Http\Request;

/**
 * listCustomerResponseTimes
 */
class ListCustomerResponseTimes extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/customerResponseTimes";
    }

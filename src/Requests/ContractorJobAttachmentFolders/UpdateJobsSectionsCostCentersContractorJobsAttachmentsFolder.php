...
/**
 * updateJobsSectionsCostCentersContractorJobsAttachmentsFolder
 */
class UpdateJobsSectionsCostCentersContractorJobsAttachmentsFolder extends Request implements HasBody
{
    use HasJsonBody;

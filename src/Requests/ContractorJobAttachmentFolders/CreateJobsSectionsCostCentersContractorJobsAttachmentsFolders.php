...
/**
 * createJobsSectionsCostCentersContractorJobsAttachmentsFolders
 */
class CreateJobsSectionsCostCentersContractorJobsAttachmentsFolders extends Request implements HasBody
{
    use HasJsonBody;

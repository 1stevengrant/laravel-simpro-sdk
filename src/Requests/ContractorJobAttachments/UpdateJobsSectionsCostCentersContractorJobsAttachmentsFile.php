...
/**
 * updateJobsSectionsCostCentersContractorJobsAttachmentsFile
 */
class UpdateJobsSectionsCostCentersContractorJobsAttachmentsFile extends Request implements HasBody
{
    use HasJsonBody;

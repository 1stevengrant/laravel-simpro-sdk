...
/**
 * createJobsSectionsCostCentersContractorJobsAttachmentsFiles
 */
class CreateJobsSectionsCostCentersContractorJobsAttachmentsFiles extends Request implements HasBody
{
    use HasJsonBody;

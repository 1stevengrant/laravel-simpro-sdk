...
namespace StevenGrant\SimproSdk\Requests\EmployeeCustomFields;

use Saloon\Enums\Method;
use Saloon\Http\Request;

/**
 * listEmployeesCustomFields
 */
class ListEmployeesCustomFields extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/employees/{$this->employeeId}/customFields";
    }

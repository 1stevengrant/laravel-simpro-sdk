 ...
 * listCatalogs
 */
class ListCatalogs extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/catalogs";
    }
     ...
     * @param  null|mixed  $searchText  Set a wildcard search text to filter catalogs by search term, name or part number.
     */

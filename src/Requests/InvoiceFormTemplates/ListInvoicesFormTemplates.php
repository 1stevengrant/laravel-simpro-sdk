...
namespace StevenGrant\SimproSdk\Requests\InvoiceFormTemplates;

use Saloon\Enums\Method;
use Saloon\Http\Request;

/**
 * listInvoicesFormTemplates
 */
class ListInvoicesFormTemplates extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/invoices/{$this->invoiceId}/formTemplates";
    }

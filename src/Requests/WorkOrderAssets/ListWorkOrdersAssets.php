...
namespace StevenGrant\SimproSdk\Requests\WorkOrderAssets;

use Saloon\Enums\Method;
use Saloon\Http\Request;

/**
 * listWorkOrdersAssets
 */
class ListWorkOrdersAssets extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/workOrders/{$this->workOrderId}/assets";
    }

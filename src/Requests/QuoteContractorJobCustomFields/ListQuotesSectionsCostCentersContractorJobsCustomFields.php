...
/**
 * listQuotesSectionsCostCentersContractorJobsCustomFields
 */
class ListQuotesSectionsCostCentersContractorJobsCustomFields extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/quotes/{$this->quoteId}/sections/{$this->sectionId}/costCenters/{$this->costCenterId}/contractorJobs/{$this->contractorJobId}/customFields";
    }

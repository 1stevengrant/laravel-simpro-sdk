...
namespace StevenGrant\SimproSdk\Requests\Journals;

use Saloon\Enums\Method;
use Saloon\Http\Request;

/**
 * listAccountsJournals
 */
class ListAccountsJournals extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/accounts/journals";
    }

...
/**
 * listVendorsContactsCustomFields
 */
class ListVendorsContactsCustomFields extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/vendors/{$this->vendorId}/contacts/{$this->contactId}/customFields";
    }

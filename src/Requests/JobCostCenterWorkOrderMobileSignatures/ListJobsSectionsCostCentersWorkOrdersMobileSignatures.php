...
namespace StevenGrant\SimproSdk\Requests\JobCostCenterWorkOrderMobileSignatures;

use Saloon\Enums\Method;
use Saloon\Http\Request;

/**
 * listJobsSectionsCostCentersWorkOrdersMobileSignatures
 */
class ListJobsSectionsCostCentersWorkOrdersMobileSignatures extends Request
{

...
namespace StevenGrant\SimproSdk\Requests\QuoteCostCenterCatalogItems;
...
/**
 * createQuotesSectionsCostCentersCatalogs
 */
class CreateQuotesSectionsCostCentersCatalogs extends Request implements HasBody
{
    use HasJsonBody;

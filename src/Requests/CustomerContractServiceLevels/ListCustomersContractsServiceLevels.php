...
namespace StevenGrant\SimproSdk\Requests\CustomerContractServiceLevels;

use Saloon\Enums\Method;
use Saloon\Http\Request;

/**
 * listCustomersContractsServiceLevels
 */
class ListCustomersContractsServiceLevels extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/customers/{$this->customerId}/contracts/{$this->contractId}/serviceLevels";
    }

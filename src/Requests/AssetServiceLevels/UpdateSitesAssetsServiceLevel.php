...
/**
 * updateSitesAssetsServiceLevel
 */
class UpdateSitesAssetsServiceLevel extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/api/v1.0/companies/{$this->companyId}/sites/{$this->siteId}/assets/{$this->assetId}/serviceLevels/{$this->serviceLevelId}";
    }

...
namespace StevenGrant\SimproSdk\Requests\CustomerLaborRateSearch;

use Saloon\Enums\Method;
use Saloon\Http\Request;

/**
 * listCustomerLaborRates
 */
class ListCustomerLaborRates extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/customerLaborRates";
    }

...
namespace StevenGrant\SimproSdk\Requests\JobForms;
 ...
 * getJobsViewForm
 */
class GetJobsViewForm extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/jobs/{$this->jobId}/viewForm/{$this->formTemplateId09}";
    }

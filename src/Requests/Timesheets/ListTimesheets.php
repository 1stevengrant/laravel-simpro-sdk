...
namespace StevenGrant\SimproSdk\Requests\Timesheets;
 ...
 * listTimesheets
 */
class ListTimesheets extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/timesheets";
    }
     ...
     * @param  null|mixed  $employeeId  Filter timesheets by employee or contractor ID
     */
    public function __construct(
        ...
        protected mixed $employeeId = null,
    ) {}

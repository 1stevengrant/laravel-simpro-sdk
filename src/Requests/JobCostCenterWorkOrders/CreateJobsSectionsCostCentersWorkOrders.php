...
namespace StevenGrant\SimproSdk\Requests\JobCostCenterWorkOrders;
...
/**
 * createJobsSectionsCostCentersWorkOrders
 */
class CreateJobsSectionsCostCentersWorkOrders extends Request implements HasBody
{
    use HasJsonBody;

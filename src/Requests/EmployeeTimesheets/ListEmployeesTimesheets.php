...
namespace StevenGrant\SimproSdk\Requests\EmployeeTimesheets;

use Saloon\Enums\Method;
use Saloon\Http\Request;

/**
 * listEmployeesTimesheets
 */
class ListEmployeesTimesheets extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/api/v1.0/companies/{$this->companyId}/employees/{$this->employeeId}/timesheets";
    }

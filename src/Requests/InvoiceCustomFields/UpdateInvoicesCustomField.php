...
namespace StevenGrant\SimproSdk\Requests\InvoiceCustomFields;
...
/**
 * updateInvoicesCustomField
 */
class UpdateInvoicesCustomField extends Request implements HasBody
{
    use HasJsonBody;

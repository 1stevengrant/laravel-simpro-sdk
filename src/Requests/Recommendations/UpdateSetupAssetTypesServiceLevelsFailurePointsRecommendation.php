...
/**
 * updateSetupAssetTypesServiceLevelsFailurePointsRecommendation
 */
class UpdateSetupAssetTypesServiceLevelsFailurePointsRecommendation extends Request implements HasBody
{
    use HasJsonBody;

...
/**
 * createSetupAssetTypesServiceLevelsFailurePointsRecommendations
 */
class CreateSetupAssetTypesServiceLevelsFailurePointsRecommendations extends Request implements HasBody
{
    use HasJsonBody;

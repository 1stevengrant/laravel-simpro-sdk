...
use StevenGrant\SimproSdk\Requests\CostToCompleteOperationsView\ListReportsJobsCostToCompleteOperations;

class CostToCompleteOperationsView extends BaseResource
{
    /**
     ...
     */
    public function listReportsJobsCostToCompleteOperations(
        mixed $companyId,
        mixed $search = null,
        mixed $date = null,
        ...
        return $this->connector->send(new ListReportsJobsCostToCompleteOperations($companyId, $search, $date, $changeOrders, $includeCommitted, $includeOverheads, $businessGroup, $costCentre, $customerId, $siteId, $customerGroup, $customerProfile, $salesPerson, $projectManager, $projectStatus, $projectTags, $customerTags, $jobId));
    }
}

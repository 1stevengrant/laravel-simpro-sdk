...
use StevenGrant\SimproSdk\Requests\EmployeeTimesheets\ListEmployeesTimesheets;

class EmployeeTimesheets extends BaseResource
{
    /**
     ...
     */
    public function listEmployeesTimesheets(
        mixed $companyId,
        mixed $employeeId,
        mixed $search = null,
        mixed $columns = null,
        ...
        return $this->connector->send(new ListEmployeesTimesheets($companyId, $employeeId, $search, $columns, $uid, $startDate, $endDate, $includes, $scheduleType));
    }
}

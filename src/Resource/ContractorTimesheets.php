...
use StevenGrant\SimproSdk\Requests\ContractorTimesheets\ListContractorsTimesheets;

class ContractorTimesheets extends BaseResource
{
    /**
     ...
     */
    public function listContractorsTimesheets(
        mixed $companyId,
        mixed $contractorId,
        mixed $search = null,
        mixed $columns = null,
        ...
        return $this->connector->send(new ListContractorsTimesheets($companyId, $contractorId, $search, $columns, $uid, $startDate, $endDate, $includes, $scheduleType));
    }
}
